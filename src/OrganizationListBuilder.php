...
class OrganizationListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new OrganizationListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total organizations: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\mbgna_organization\OrganizationInterface $entity */
    $row['id'] = $entity->id();
